...
export async function GET() {
  const users = [
    { id: 1, user_id: 4930835, context: 'Keppi is a very talented engineer, has a deep knowledge of classical music, and is a skilled piano player. There is no one who doesn\'t love him.', created_at: 1723806287, repost_count: 0, likes_count: 810, comments_count: 0 },
