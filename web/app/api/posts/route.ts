...
export async function GET() {
  const users = [
    ...
    { id: 9, user_id: 35152, context: 'シューマンのピアノ競争曲\nあああ', created_at: 1723806287, likes_count: 0, comments_count: 0 },
    { id: 10, user_id: 35152, context: 'ラフマニノフチョピン', created_at: 1723806287, likes_count: 0, comments_count: 0 },
  ];
